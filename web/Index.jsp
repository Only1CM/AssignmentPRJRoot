<%-- 
    Document   : Index
    Created on : Jun 27, 2024, 12:29:00 AM
    Author     : Nhat Anh
--%>
    ...
    <body>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <a class="btn-book-a-table" href="Login.jsp">Log in</a>
                        ...
                        <div class="tab-pane fade" id="menu-dinner">
                            ...
                            <div class="row gy-5">
                                ...
                                for (int i = 0; i < foodList.size(); i++)
                                {
                                    ...
                                    %>
                                     <div class="col-lg-4 menu-item" id="food-img">
                                    <a href="<%=f.getFood_img()%>" class="glightbox"><img src="<%=f.getFood_img()%>" class="menu-img img-fluid" alt=""></a>
                                    <h4><%=f.getName()%></h4>
                                    <p class="price">
                                        <%=f.getPrice()%>
                                    </p>
