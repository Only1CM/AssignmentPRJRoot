<%-- 
    Document   : AdminPage
    Created on : Jun 13, 2024, 11:37:19 AM
    Author     : Admin
--%>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a href="/AssignmentPRJRoot/ListUser">Quản lý tài khoản</a></li>
                        <li><a href="/AssignmentPRJRoot/CustomerOrder">Đơn hàng của khách hàng</a></li>
                    </ul>
                </nav><!-- .navbar -->

                <%-- Phân quyền chỉ tài khoản có role là Admin mới được vào trang này--%>
                <%@include file="CheckAdminRole.jsp" %>
                <%
                    User adminUser = (User) session.getAttribute("user");
                    String helloUser = adminUser.getLast_name() + adminUser.getFirst_name();
                %>
