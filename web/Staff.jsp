<%-- 
    Document   : Staff
    Created on : Jun 13, 2024, 12:01:08 AM
    Author     : Admin
--%>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar" style="margin-left: 20%">
                    <ul>
                        ...
                        <li><a href="/AssignmentPRJRoot/FoodMenu">Menu</a></li>
                        <li><a href="#events">Events</a></li>
                        <li><a href="#chefs">Chefs</a></li>
                        <li><a href="#contact">Contact</a></li>
                        <li><a href="/AssignmentPRJRoot/CustomerOrder">Đơn hàng của khách hàng</a></li>
                    </ul>
                </nav><!-- .navbar -->

                <%-- Phân quyền chỉ tài khoản có role là Staff mới được vào trang này--%>
                <%@include file="CheckStaffRole.jsp" %>
                <%                                   
                    User staffUser = (User) session.getAttribute("user");
                    String helloUser = staffUser.getLast_name() + staffUser.getFirst_name();
                %>
                <nav id="navbar" class="navbar" style="margin-left: 28%">
                    <div>
