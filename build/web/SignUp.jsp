                ...
                <div id="form_login">
                    <form class="bieumau" method="post" action="UserSignUp">
                        <div class="container-input">
                            <input id="custom-input-user" placeholder="Username" class="nhap" type="text" name="username"><br />
                        </div>
                        <div class="container-input">
                        ...
                        <div class="container-input">
                            <input id="custom-input-re-pass" placeholder="Re-enter password" class="nhap" type="password" name="re-pass"><br />
                        </div>
